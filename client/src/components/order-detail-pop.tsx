...
export default function OrderDetailPopup({
  ...
  return (
    ...
    >
            ...
            <div ref={targetRef}>
              ...
              <div className="space-y-4">
                ...
                <p>
                  ...
                  <span className={`px-2 py-1 rounded`}>{order.status}</span>
                </p>
                <p>
      ...
      <div className="text-white bg-green-600 hover:bg-green-400 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 text-center">
